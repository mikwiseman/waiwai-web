...
export const awards = [
  { name: 'ETHglobal San Francisco', award: '1st Place, AI-collabs Category (2024)', link: 'https://ethglobal.com/showcase/benderbite-331m7', medal: 'gold' },
  { name: 'ETHGlobal Brussels', award: '1st Place, AI-chat-bots Category (2024)', link: 'https://ethglobal.com/showcase/llamarally-52jka', medal: 'gold' },
  { name: 'ETHGlobal Singapore', award: '3rd Place, Web3 Services Category (2024)', link: 'https://ethglobal.com/showcase/veretha-pskzp', medal: 'bronze' },
  { name: 'AI Conversations 2025', award: 'Winner, Best GenAI Startup Category (2025)', medal: 'gold' },
  { name: 'AI Digital Leaders', award: 'Best AI Startup (2025)', medal: 'gold' }
]
